...
<script type="text/x-red" data-help-name="moment">
    ...
    <h2>Input</h2>
    <p>
      Must be either a JS datetime object or a <a href="http://momentjs.com/docs/#/parsing/">string that Moment.js</a> can resolve
      (with the help of <a href="https://github.com/gr2m/moment-parseformat">moment.parseFormat</a>).
      If the input is null, does not exist or is a blank string, the current Date/Time will be used.
    </p>
    <p>
      This can be used to add a current timestamp to a flow of any kind easily.
    </p>
    <h3>String input warnings</h3>
    <p>
    ...
    <h2>Output String Formatting</h2>
    <p>
